            ...
            <div class="space-y-6">
                ...
                <div>
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h4 class="text-sm font-semibold text-gray-900">Prompt 2</h4>
                        ...
                        <div class="flex flex-col gap-2 sm:flex-row">
                            <button
                                type="button"
                                onclick="navigator.clipboard.writeText(document.getElementById('content_drafting_prompt_preview').value)"
                            ...
                            <div class="rounded-xl border border-gray-200 bg-gray-50 p-4">
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                    <div class="min-w-0">
                                        ...
                                        <div class="mt-1 text-xs text-gray-600">
                                            Plantilla: {{ \App\Support\ContentManagementLabels::stepType(optional(optional($generation->templateVersion)->masterTemplate)->key ?: \App\Models\ContentArticleStep::TYPE_DRAFTING) }}
